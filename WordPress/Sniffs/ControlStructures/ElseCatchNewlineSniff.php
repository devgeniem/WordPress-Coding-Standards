...
namespace WordPress\Sniffs\ControlStructures;
 ...
 * Checks that else/elseif/catch statements start on a new line.
 *
 * This has been copied originally from: https://github.com/zroger/phpcs-drupal/blob/master/Sniffs/ControlStructures/ElseCatchNewlineSniff.php
 *
 * @category PHP
 * @package  PHP_CodeSniffer
 * @link     http://pear.php.net/package/PHP_CodeSniffer
